...
# (1100) Michael Dellnitz (Paderborn), Andreas Bittracher (FU Berlin) and Sebastian Peitz (Paderborn)
...
# (1500) Bernard Haasdonk (Stuttgart), Gabriele Santin (Stuttgart) and T. Brunnette (Stuttgart)
...
# (1530) Boumediene Hamzi (Imperial College London)
